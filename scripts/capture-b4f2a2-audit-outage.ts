...
const main = async () => {
  ...
  const containerName = `crewframe-b4f2a2-audit-${suffix}`
  ...
  const outputPath = path.join(
    ...
    'docs',
    'evidence',
    'CF-P1-B4F2A2-audit-outage.json'
  )
  ...
  console.log('PASS captured three bounded B4F2A2 audit-service outage attempts')
}
